...
if __name__ == '__main__':
    ...
    print("Calculate thrust generated by engine, please enter parameters:")
    pop_size = int(input("Enter population size: "))
    mutation_rate = float(input("Enter mutation rate (0.00 - 1.00): "))
    selection_scheme = int(input("Enter desired selection scheme. 0 = Elitist, 1 = Roulette: "))
    termination_condition = int(input("Enter termination condition. 0 = 100 max generations, 1 = max average error < 0.3: "))
    answer = int(input("Enter target thrust: "))
    ...
    while average_population_fitness > stop_threshold and max_generations > generation:
        ...
        if bool(selection_scheme):
            # Roulette selection
            selection = []
            for j in range(pop_size):
                selection.append(math.log(pop_size-j))
            for k in range(1, int(pop_size/5) + 1):
                ...
                population[len(population) - k] = new_offspring
        else:
            # Elitist selection
